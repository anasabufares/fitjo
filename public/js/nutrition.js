...
const FOODS = [
  ...
  // fruits
  { name: { en: "Orange", ar: "برتقال" }, kcal: 47, p: 0.9, c: 12, f: 0.1 },
  { name: { en: "Grapes", ar: "عنب" }, kcal: 69, p: 0.7, c: 18, f: 0.2 },
  { name: { en: "Watermelon", ar: "بطيخ" }, kcal: 30, p: 0.6, c: 8, f: 0.2 },
  { name: { en: "Strawberries", ar: "فراولة" }, kcal: 32, p: 0.7, c: 8, f: 0.3 },
  { name: { en: "Mango", ar: "مانجو" }, kcal: 60, p: 0.8, c: 15, f: 0.4 },
  { name: { en: "Pineapple", ar: "أناناس" }, kcal: 50, p: 0.5, c: 13, f: 0.1 },
  // veg
  { name: { en: "Broccoli", ar: "بروكلي" }, kcal: 34, p: 2.8, c: 7, f: 0.4 },
  { name: { en: "Cucumber", ar: "خيار" }, kcal: 15, p: 0.7, c: 3.6, f: 0.1 },
  { name: { en: "Tomato", ar: "طماطم" }, kcal: 18, p: 0.9, c: 3.9, f: 0.2 },
  { name: { en: "Spinach", ar: "سبانخ" }, kcal: 23, p: 2.9, c: 3.6, f: 0.4 },
  { name: { en: "Sweet potato", ar: "بطاطا حلوة" }, kcal: 86, p: 1.6, c: 20, f: 0.1 },
  { name: { en: "Corn", ar: "ذرة" }, kcal: 96, p: 3.4, c: 21, f: 1.5 },
  // proteins
  { name: { en: "Tuna (canned)", ar: "تونة معلبة" }, kcal: 116, p: 26, c: 0, f: 1 },
  { name: { en: "Shrimp", ar: "روبيان" }, kcal: 99, p: 24, c: 0, f: 0.3 },
  { name: { en: "Turkey breast", ar: "صدر ديك رومي" }, kcal: 135, p: 30, c: 0, f: 1 },
  { name: { en: "Tofu", ar: "توفو" }, kcal: 76, p: 8, c: 1.9, f: 4.8 },
  { name: { en: "Chickpeas", ar: "حمص حب" }, kcal: 164, p: 9, c: 27, f: 2.6 },
  { name: { en: "Kidney beans", ar: "فاصولياء حمراء" }, kcal: 127, p: 9, c: 22, f: 0.5 },
  { name: { en: "Peanut butter", ar: "زبدة فول سوداني" }, kcal: 588, p: 25, c: 20, f: 50 },
  // grains / carbs
  { name: { en: "Brown rice", ar: "رز بني" }, kcal: 123, p: 2.7, c: 26, f: 1 },
  { name: { en: "Quinoa", ar: "كينوا" }, kcal: 120, p: 4.4, c: 21, f: 1.9 },
  { name: { en: "Cornflakes", ar: "رقائق ذرة" }, kcal: 357, p: 7, c: 84, f: 0.4 },
  { name: { en: "Croissant", ar: "كرواسون" }, kcal: 406, p: 8, c: 46, f: 21 },
  // MidEast / world dishes
  { name: { en: "Mansaf", ar: "منسف" }, kcal: 200, p: 12, c: 18, f: 9 },
  { name: { en: "Maqluba", ar: "مقلوبة" }, kcal: 180, p: 8, c: 22, f: 7 },
  { name: { en: "Kebab", ar: "كباب" }, kcal: 250, p: 17, c: 3, f: 19 },
  { name: { en: "Manakish zaatar", ar: "مناقيش زعتر" }, kcal: 290, p: 7, c: 38, f: 12 },
  { name: { en: "Foul medames", ar: "فول مدمس" }, kcal: 110, p: 8, c: 16, f: 1.5 },
  { name: { en: "Tabbouleh", ar: "تبولة" }, kcal: 120, p: 2.5, c: 12, f: 7 },
  { name: { en: "Kunafa", ar: "كنافة" }, kcal: 350, p: 6, c: 40, f: 18 },
  { name: { en: "Pizza (cheese)", ar: "بيتزا جبنة" }, kcal: 266, p: 11, c: 33, f: 10 },
  { name: { en: "Burger", ar: "برجر" }, kcal: 295, p: 17, c: 24, f: 14 },
  { name: { en: "Fries", ar: "بطاطا مقلية" }, kcal: 312, p: 3.4, c: 41, f: 15 },
  { name: { en: "Sushi (roll)", ar: "سوشي" }, kcal: 145, p: 5, c: 30, f: 0.7 },
  { name: { en: "Pad thai", ar: "باد تاي" }, kcal: 153, p: 7, c: 20, f: 5 },
  { name: { en: "Fried chicken", ar: "دجاج مقلي" }, kcal: 246, p: 19, c: 8, f: 15 },
  // dairy / drinks / sweets
  { name: { en: "Cheddar cheese", ar: "جبنة شيدر" }, kcal: 402, p: 25, c: 1.3, f: 33 },
  { name: { en: "Butter", ar: "زبدة" }, kcal: 717, p: 0.9, c: 0.1, f: 81 },
  { name: { en: "Honey", ar: "عسل" }, kcal: 304, p: 0.3, c: 82, f: 0 },
  { name: { en: "Dark chocolate", ar: "شوكولاتة داكنة" }, kcal: 546, p: 5, c: 61, f: 31 },
  { name: { en: "Ice cream", ar: "آيس كريم" }, kcal: 207, p: 3.5, c: 24, f: 11 },
  { name: { en: "Orange juice", ar: "عصير برتقال" }, kcal: 45, p: 0.7, c: 10, f: 0.2 },
